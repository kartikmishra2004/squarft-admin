import { dashboardMetrics, mockBranches, roleDistribution } from '../../data/mockData';
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
                        ...
                        <div className="xl:col-span-2">
                            <BranchLeaderboard 
                                ...
                                onManageClick={() => console.log("Manage Branches clicked")}
                            />
                        </div>
                        ...
                        <div className="xl:col-span-1">
                            <UserRoleDistribution 
                                ...
                                onManageClick={() => console.log("Manage Users clicked")}
                            />
                        </div>
                    </div>
                </div>
