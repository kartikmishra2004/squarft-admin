                ...
                followUps: [
                    {
                        ...
                        status: 'Hot',
                        isDone: false,
                        voiceNoteUrl: 'https://www.w3schools.com/html/horse.mp3',
                    ...
                    },
                    {
                        id: 'fu-skyline-2',
                        time: '03:00 PM',
                        note: 'Follow up on document upload and compliance files.',
                        status: 'Warm',
                        isDone: true,
                        meta: { followUpType: 'Visit', outcome: 'Pending upload', nextAction: 'Help upload files', nextFollowUpAt: '2026-06-16T05:30:00.000Z' },
                    },
                    {
                        id: 'fu-skyline-3',
                        time: '09:30 AM',
                        note: 'Call builder to check on joint venture agreement signing.',
                        status: 'Cold',
                        isDone: false,
                        meta: { followUpType: 'Call', outcome: 'Busy', nextAction: 'Callback later', nextFollowUpAt: '2026-06-17T05:30:00.000Z' },
                    },
                    {
                        id: 'fu-skyline-4',
                        time: '01:00 PM',
                        note: 'Shared rate card details and marketing brochure draft.',
                        status: 'Hot',
                        isDone: true,
                        voiceNoteUrl: 'https://www.w3schools.com/html/horse.mp3',
                        voiceNoteDuration: '0:05',
                        meta: { followUpType: 'Call', outcome: 'Interested', nextAction: 'Negotiate brokerage terms', nextFollowUpAt: '2026-06-17T05:30:00.000Z' },
                    },
                    {
                        id: 'fu-skyline-5',
                        time: '04:00 PM',
                        note: 'Collect layout blueprint and site layout photos.',
                        status: 'Warm',
                        isDone: false,
                        meta: { followUpType: 'Visit', outcome: 'Awaiting copy', nextAction: 'Visit site office', nextFollowUpAt: '2026-06-18T05:30:00.000Z' },
                    },
                    {
                        id: 'fu-skyline-6',
                        time: '10:30 AM',
                        note: 'Schedule follow-up meeting with regional sales director.',
                        status: 'Hot',
                        isDone: false,
                        voiceNoteUrl: 'https://www.w3schools.com/html/horse.mp3',
                        voiceNoteDuration: '0:05',
                        meta: { followUpType: 'Call', outcome: 'Confirmed', nextAction: 'Sync with RM', nextFollowUpAt: '2026-06-18T05:30:00.000Z' },
                    },
                    {
                        id: 'fu-skyline-7',
                        time: '02:30 PM',
                        note: 'Received RERA certificate copy; verify online registry details.',
                        status: 'Warm',
                        isDone: true,
                        meta: { followUpType: 'Call', outcome: 'Verified', nextAction: 'Update compliance status', nextFollowUpAt: '2026-06-19T05:30:00.000Z' },
                    },
                ],
                meetings: [
                    {
                    ...
                    },
                    {
                        ...
                        meta: {
                            ...
                            agenda: ['Verify KYC Documents', 'Discuss Commission Structure'],
                            notes: 'Met with Arjun Mehra. Verified RERA credentials and GST.',
                    ...
                    },
                    {
                        ...
                        meta: {
                            ...
                            agenda: ['Check Compliance Upload Progress'],
                            notes: 'Call to assist with GST certificate upload issues.',
                    ...
                    },
                    {
                        ...
                        isDone: false,
                        meta: {
                            scheduledAt: '2026-06-17T04:30:00.000Z',
                            agenda: ['Review Visual Builder Onboarding Form'],
                            notes: 'Walkthrough of the inventory upload tool on portal.',
                            reminder: '15 minutes before',
                        },
                    },
                    {
                        id: 'mt-skyline-5',
                        location: 'Vijay Nagar site location',
                        latitude: 22.7533,
                        longitude: 75.8937,
                        type: 'Site Meeting',
                        time: '11:30 AM',
                        ...
                        voiceNoteDuration: '0:05',
                        meta: {
                            scheduledAt: '2026-06-17T06:00:00.000Z',
                            agenda: ['Verify layout and boundary walls'],
                            notes: 'Physical site verification completed. Captured coordinate pins.',
                            reminder: '1 hour before',
                        },
                    },
                    {
                        ...
                        isDone: false,
                        meta: {
                            scheduledAt: '2026-06-18T09:30:00.000Z',
                            agenda: ['Finalize Onboarding Agreement'],
                            notes: 'Carry printed copy of service level agreement (SLA).',
                    ...
                    },
                    {
                        ...
                        isDone: true,
                        meta: {
                            scheduledAt: '2026-06-18T11:30:00.000Z',
                            agenda: ['Verify bank account details for payouts'],
                            notes: 'Confirmed Bank of Baroda corporate escrow details.',
