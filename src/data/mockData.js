...
export const mockDeals = [
    ...
    { dealCode: 'D0006', customer: 'Durgesh', property: 'Sapana', city: 'Indore', salesOfficer: 'Rizwan Khan', broker: 'SquarFT 92', status: 'FINALIZED', createdOn: '28/02/26', customerPhone: '9876543210', brokerMobile: '-', salesOfficerMobile: '-', prefLocation: '-', propType: 'PLOT', address: '-', khasra: '-', expectPrice: 500000, negotiationPrice: 500000, remainingBalance: 0, payments: [], timeline: [], notes: [], meetings: [], documents: [] },
