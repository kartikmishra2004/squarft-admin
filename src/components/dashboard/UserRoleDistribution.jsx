...
const UserRoleDistribution = ({ roleData, onManageClick }) => (
    <Card className="flex flex-col relative overflow-hidden shadow-lg border-gray-200 h-full">
        ...
        <div className="flex justify-between items-center mb-8 z-10">
            ...
            <button className="p-2 bg-gray-50 rounded-lg hover:bg-[#6F4BFF]/10 hover:text-[#6F4BFF] transition-colors text-gray-400">
